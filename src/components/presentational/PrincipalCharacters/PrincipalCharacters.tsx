    ...
    return (
      ...
      <StackStyled>
        {characters.map((element)=>{
          return (
         <CardStyle gender={element.gender} sx={{ width: {xs:'100%',md:'17%',lg:'20%'}, margin:{xs:10, md:'10px 25px'} }} key={element.id}>
         <CardMedia
        ...
        <Stack spacing={2} display='flex' justifyContent='center' flexDirection='row'>
